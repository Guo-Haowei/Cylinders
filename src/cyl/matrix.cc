...
**
** $Header: /p/SurfaceFitting/geometry.ansi/RCS/matrix.c,v 1.1 1996/04/05 15:25:57 smann Exp smann $
**
...
extern void DefMatrixError(const char*);

/* Error handling routine */
static void (*MatrixError)(const char*) = DefMatrixError;

/*
** Set the matrix error handling routine.
*/
void SetMatrixError( void (*ErrorFunc)(const char*) )
{
...
*/
void DefMatrixError( const char *errmesg)
{
...
** Print a matrix
*/
void MatrixPrint(Matrix M, FILE *fp)
{
	int i, j;
...
*/
Matrix MatrixScale(Scalar s, Matrix M)
{
	int i, j;
...
*/
Matrix MatrixAdjoint( Matrix* M, int i, int j)
{
